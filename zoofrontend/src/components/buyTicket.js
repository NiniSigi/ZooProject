...
const BuyTicket = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (name && (ticketType !== 'twoDayTicket') && eventDate) {
    ...
    <div className="container mt-5">
      ...
      {!ticketGenerated ? (
        <form onSubmit={handleSubmit} className="mb-4">
          ...
          {ticketType === 'event' && (
            <div className="mb-3">
              <label htmlFor="eventSelection" className="form-label">Event:</label>
              <select className="form-select" id="eventSelection" value={eventSelection} onChange={(e) => setEventSelection(e.target.value)}>
        ...
        <div className="card">
          <div className="card-body">
            ...
            {ticketType === 'event' && (
              <>
                <p className="card-text"><strong>Event:</strong> {eventSelection}</p>
                <p className="card-text"><strong>Datum:</strong> {eventDate}</p>
              </>
            )}
